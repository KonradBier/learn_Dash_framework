...
index_page: Div = html.Div([
    html.H3('MENU:'),
    dcc.Link('Wybierz technilogię', href='/tech'),
    html.Br(),  # przejscie do nast wiersza
    dcc.Link('Podaj swoje doświadczenie', href='/experience')
])

tech_layout = html.Div([
    html.H4('Wybierz technologię'),
    dcc.Dropdown(
        id='tech-1-dropdown',
...
experience_layout = html.Div([
    ...
    dcc.RadioItems(
        ...
        options=[{'label': i, 'value': i} for i in ['poniżej 1 roku', 'od 1 do 3 lat', 'powyzej 3 lat']],
        value=''
    ),
